...
class scrapy_sql:
    def __init__(self):
        print(config.sql_config)
        self.conn = psycopg2.connect(
            dbname=config.sql_config['dbname'],
    ...
    def insert(self, table_name, data_dict):
        ...
        try:
            ...
            logging.error(f"sql insert error: {e}")
            self.conn.rollback()
...
if __name__ == '__main__':
    ...
    data = {
        ...
        'ios_last_update': '', 'tag': ['类Rogue', 'rougelike', '赛博朋克', 'steam移植', '地牢', '像素'], 'mark': 8.0,
        'comments_count': 1230, 'download_count': 212897, 'book_num': 2082, 'take_time': 1730084388,
        'key_word': '霓虹深渊', 'execute_id': 245, 'execute_name': '测试2', 'web_site': 'bilibili'}
